function DiagramContainer() {
  ...
  this.setInitialDiagram = function () {
    ...
    this.reAssignEvents();
    this.actualDiagram = new NSPDiagram(
      this.diagramClass(),
      this.diagramName(),
      this.container.innerHTML
    );
  ...
  this.bindVarsAndSignature = function () {
    this.localVars = document.querySelector(
      '#actualDiagram .local-variable-declaration'
    );
    this.methodParameters = document.querySelector(
      '#actualDiagram .method-parameters'
    );
  };
  ...
  this.reAssignSwitchEvents = function () {
    var switchAddButtons = document.querySelectorAll(
      '#actualDiagram .switch-add-button'
    );
    var switchRemoveButtons = document.querySelectorAll(
      '#actualDiagram .switch-remove-button'
    );
  ...
  this.insertStatementInTarget = function (target, statement) {
    var parent =
      target.parentNode == this.container ? target : target.parentNode;
  ...
  this.classNameContainer = function () {
    return document.querySelector(
      '#actualDiagram .class-name>.input-for-statement'
    );
  };
  this.methodNameContainer = function () {
    return document.querySelector(
      '#actualDiagram .method-name>.input-for-statement'
    );
  };
