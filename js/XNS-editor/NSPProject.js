function NSPProject(data) {
  ...
  function starCheckTimer() {
    if (_evStart) {
      var now = new Date();
      var status =
        _evStart.valueOf() <= now.valueOf() && now.valueOf() <= _evEnd;
      if (status != _iem) {
        _iem = status;
        if (_env.notify) {
  ...
  function resetData() {
    _data = JSON.parse(JSON.stringify(_defaults));
  }
  function setData(obj) {
    for (x in _data) if (obj[x]) _data[x] = obj[x];
  }
  function setEnv(obj) {
    for (x in _env) if (obj[x]) _env[x] = obj[x];
  }
  ...
  function getDiagramById(id) {
    var diag = null,
      i = 0;
    while (i < _diagrams.length && _diagrams[i].id != id) {
      i++;
    }
    if (i < _diagrams.length) {
      diag = _diagrams[i];
    }
    return diag;
  }
    ...
    var obj = {
      ...
      ...(complete
        ? {
            ...
            date: _date,
            minutes: _minutes,
            sem: isEvalTime() ? _env['evs'] : undefined,
          }
        : {}),
    };
    ...
    if (_meta) {
      ...
      if (_data && _data['sem']) {
        ...
        row.innerHTML =
          _data['com'] +
          ' - Cierre: ' +
          DataConversor.toDate(_data['sem']).toLocaleString();
      ...
      for (var i = 0; i < _log.length; i++) {
        ...
        row.appendChild(
          newRow(new Date(_log[i].i.start).toLocaleString(), 'date')
        );
  ...
  function importFromJSON(obj) {
    ...
    setData(obj);
    setMeta(obj.meta);
    if (isEvalTime() && !(isTeacher() || isMyFile(obj['autor'] || obj['usr'])))
      throw 'Invalid';
    obj.diagrams.forEach((diagram) => {
      addDiagram(new NSPDiagram(diagram.theClass, diagram.name, diagram.code));
    });
  }
  function isMyFile(a) {
    return a == _env['usr'];
  ...
  function setMeta(value) {
    _meta = value;
    _log = DataConversor.toJS(_meta);
  }
  function getMeta() {
    return _meta;
  }
  function getDiagramLength() {
    return _diagrams.length;
  }
  function hasDiagrams() {
    return getDiagramLength() > 0;
  }
  function getResolutionTime() {
    if (!_minutes) updateTime();
    return _minutes;
  }

  function getFirst() {
    return hasDiagrams ? _diagrams[0] : null;
  }
  function getDiagram(idx) {
    return _diagrams.length > idx ? _diagrams[idx] : null;
  }
  ...
  function isTeacher() {
    return _env['tea'] || (_env['uid'] && isNaN(_env['uid']));
  }
  function getFullname() {
    return (
      isEvalTime() && !isTeacher()
        ? [_env['com'], _env['uid'], getName()]
        : [getName()]
    ).join('_');
  }
  ...
  Object.defineProperty(_self, 'meta', {
    enumerable: true,
    configurable: false,
    get: getMeta,
    set: setMeta,
  ...
  Object.defineProperty(_self, 'hasDiagrams', {
    enumerable: true,
    configurable: false,
    get: hasDiagrams,
  });
  Object.defineProperty(_self, 'resolutionTime', {
    enumerable: true,
    configurable: false,
    get: getResolutionTime,
  });
  Object.defineProperty(_self, 'et', {
    enumerable: true,
    configurable: false,
    get: isEvalTime,
  });
  ...
  Object.defineProperty(_self, 'updateTime', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: updateTime,
  });
  Object.defineProperty(_self, 'moveDiagramUp', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: moveDiagramUp,
  });
  Object.defineProperty(_self, 'moveDiagramDown', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: moveDiagramDown,
  });
  Object.defineProperty(_self, 'diagramsCount', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getDiagramLength,
  });
  Object.defineProperty(_self, 'publishTo', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: publish,
  });
  Object.defineProperty(_self, 'getFirst', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getFirst,
  });
  Object.defineProperty(_self, 'addDiagram', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: addDiagram,
  });
  Object.defineProperty(_self, 'deleteDiagram', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: deleteDiagram,
  });
  Object.defineProperty(_self, 'getDiagram', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getDiagram,
  });
  Object.defineProperty(_self, 'cloneDiagram', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: cloneDiagram,
  });
  Object.defineProperty(_self, 'fillHistorial', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: fillHistorial,
  });
  Object.defineProperty(_self, 'getForExport', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getForExport,
  });
  Object.defineProperty(_self, 'getLog', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getLog,
  });
  Object.defineProperty(_self, 'getInfo', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getInfo,
  });
  Object.defineProperty(_self, 'getDateStr', {
    enumerable: false,
    writable: false,
    configurable: false,
    value: getDateStr,
  });
  Object.defineProperty(_self, 'import', {
    enumerable: false,
    writable: false,
    configurable: false,
