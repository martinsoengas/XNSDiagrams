...
function ClassConstructor() {
  ...
  function _addProperty(propertyName, value, modAttrs) {
    if (!_self.hasOwnProperty(propertyName)) {
      ...
      if (attributes['writable']) {
        ...
        !attributes['writable'] &&
        attributes['to_clone'] &&
        _properties[propertyName] instanceof Array
      ) {
        if (Object.freeze) {
  ...
  Object.defineProperty(_self, 'addProperty', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _addProperty,
  });
  Object.defineProperty(_self, 'addEnumProperty', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _addEnumProperty,
  });
  Object.defineProperty(_self, 'addMethod', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _addMethod,
  });
  Object.defineProperty(_self, 'publish', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _publish,
  });
  Object.defineProperty(_self, 'getValue', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _getValue,
  });
  Object.defineProperty(_self, 'addObserver', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _addObserver,
  });
  Object.defineProperty(_self, 'removeObserver', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _removeObserver,
  });
  Object.defineProperty(_self, 'notify', {
    configurable: false,
    writable: false,
    enumerable: false,
    value: _notify,
  });
  Object.defineProperty(_self, 'MEMBER_VISIBILITY', {
    configurable: false,
    enumerable: 'true',
    get: _getVisibility,
  });
